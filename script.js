    ...
    installBtn.addEventListener('click', (e) => {
      ...
      const interval = setInterval(() => {
        ...
        if (progress >= 100) {
          ...
          msgBlock.style.gap = '10px';
          msgBlock.innerHTML = `
            <svg width="22" height="22" viewBox="0 0 24 24" fill="#01875f" style="flex-shrink:0;"><path d="M10 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-8l-2-2z"/></svg>
            <span style="font-size: 16px; font-weight: 500; color: var(--text);">Откройте «Загрузки», чтобы установить</span>
          `;
